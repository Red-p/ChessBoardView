package androidx.cap.app.chessboardpersdchessreferee.controller

import android.app.AlertDialog
import android.graphics.Color
import androidx.cap.app.chessboardpersdchessreferee.Tile
...
class ChessBoardController {
    ...
    private fun get_tile_for_castilng(castlingType:CastlingType) :List<Tile>{
        ...
        return tile_list
        /*val king_tile=getTileInPosition("e${turn.player}") // e1 or e8
        val blank_tile_king=getTileInPosition("c${turn.player}") // g1 or g8
        val rook_tile= getTileInPosition("a${turn.player}") // h1 or h8
        val blank_tile_rook=getTileInPosition("d${turn.player}") // f1 or f8
        return listOf(king_tile,blank_tile_king,rook_tile,blank_tile_rook)*/
    }
    ...
    fun move(move:String){ // d2/d4
        ...
        /*if(second_tile.piece_letter != " ") {

            second_tile.piece_letter = first_tile.piece_letter
